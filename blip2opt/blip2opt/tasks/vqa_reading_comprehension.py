...
from blip2opt.common.dist_utils import get_rank, get_world_size, is_main_process
from blip2opt.common.registry import registry
from blip2opt.common.vqa_tools.vqa_eval import VQAEval as VQATool
from blip2opt.tasks.vqa import VQATask
